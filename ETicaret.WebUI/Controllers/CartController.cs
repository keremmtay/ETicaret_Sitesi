...
namespace ETicaret.WebUI.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        {
            // Sepete eklediğimiz ürünleri, ödeme işlemi tamamlandıktan sonra Carts/CartItems içindeki bilgiler Orders/OrderItems tablosuna taşınmalıdır.
        ...
        private Payment PaymentProcess(OrderModel model)
        {
            ...
            options.ApiKey = "sandbox-1ecVxil0S0a06vXU5pzjSGuV1x4yAMYD";
            options.SecretKey = "sandbox-DBQFNmcoCuamhklG4fqOgeNkD9PV3eAs";
